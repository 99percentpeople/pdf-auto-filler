...
export const SwitchErrorMessage =
...
> = ParentProps<SwitchControlProps<T> & { class?: string }>;
    ...
    <>
      ...
      <SwitchPrimitive.Control
        class={cn(
          ...
          rounded-full border-2 border-transparent bg-input shadow-sm
...
type switchThumbProps<T extends ValidComponent = "div"> =
  VoidProps<SwitchThumbProps<T> & { class?: string }>;
...
>(
  ...
  return (
    <SwitchPrimitive.Thumb
      class={cn(
        `pointer-events-none block h-4 w-4 translate-x-0 rounded-full
