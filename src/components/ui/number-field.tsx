...
export const NumberFieldHiddenInput =
...
>(
  ...
  const [local, rest] = splitProps(
    props as numberFieldLabelProps,
    ["class"],
  );
  ...
  return (
    <div
      class={cn(
        ...
        focus-within:outline-none focus-within:ring-[1.5px]
...
>(
  props: PolymorphicProps<
    T,
    VoidProps<numberFieldInputProps<T>>
  >,
) => {
  const [local, rest] = splitProps(
  ...
  return (
    <NumberFieldPrimitive.Input
      class={cn(
        ...
        bg-transparent px-10 py-1 text-center text-sm shadow-sm
...
>(
  props: PolymorphicProps<
    T,
    VoidProps<numberFieldDecrementTriggerProps<T>>
  >,
) => {
  const [local, rest] = splitProps(
  ...
  return (
    <NumberFieldPrimitive.DecrementTrigger
      class={cn(
        `absolute left-0 top-1/2 -translate-y-1/2 p-3
...
>(
  ...
  return (
    <NumberFieldPrimitive.IncrementTrigger
      class={cn(
        `absolute right-0 top-1/2 -translate-y-1/2 p-3
        disabled:cursor-not-allowed disabled:opacity-20`,
        local.class,
      )}
      {...rest}
